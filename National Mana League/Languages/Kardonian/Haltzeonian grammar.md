...
| Accusative | -ca      | -ceon     | -ncil    |
| Genitive   | -seo     | -sheon    | -nsel    |
...
| Mood   | -ka         | -ku        | -ra      | -ɂeo        | -cen               | -t’ak   |
|        |             |            |          |             |                    |         |
Evidentiality is a mood because it can't be combined with one. In other words, the moods can be translated as "I demand X, I want X, I heard X, I think X, I saw X." In total, the order goes mood, then tense, then aspect.
