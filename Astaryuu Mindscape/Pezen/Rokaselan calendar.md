...
The **Rokaselan calendar** is the timekeeping system used by the [Rauratoshan Kingdom](https://arcadianodyssey.miraheze.org/wiki/Rauratoshan_Kingdom?action=edit&redlink=1 "Rauratoshan Kingdom (page does not exist)").
## Mechanics
There are two core versions of the Rokaselan calendar: the main calendar, and the divine calendar. The divine calendar is used as well, but only as a reference for durations.
### Main
...
Regardless of the name used, the year number is treated as an ordinal number - that is, "100(th year of) Kanata" or "2438(th) cycle year". Therefore, it typically ends with some variant of  _-sha_. The Gregorian dates in the below table assume that the beginning of Drawn to AfterLife takes place in February 2025, a safe assumption based on the Gregorian-adjacent Shadaric calendar.
...
| Kanata    | 1926 AD    | 2339 MK | _ongoing_ |         |
The epoch of the Rokaselan calendar is 2436 years before the present of [[Drawn to AfterLife]]; this is referred to as "1 MK" (where MS stands for "misha kótan" or "cycle year"), and supposedly is named for when the royal regalia of Rauratoshan were gifted to the first king, despite that the name implies the creation of the world in [[Yukacan]], which occurred well before that.
### Modified
