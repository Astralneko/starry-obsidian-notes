...
| **Implosive** | ɓ̥ ⟨b⟩ |          | ʄ̊ ⟨d⟩  |       |          |
### Notes
/j w/ are not distinct from /i u/ in Matelian, as Matelian does not abhor hiatus. Additionally, the palatal diacritics can be replaced with a following ⟨i⟩ in ASCII contexts.
/ɺ/ becomes \[ɫ] in the coda and \[ʎ] before \[i].
## Vowels
### Chart
